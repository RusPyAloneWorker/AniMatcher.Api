...
namespace AniMatcher.DataAccess.Migrations
{
    ...
    [Migration("20250409144922_Initial02")]
            ...
            modelBuilder.Entity("AniMatcher.Domain.Franchise", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            FranchiseId = new Guid("2c08c4ad-d038-43b3-9428-3d6857eb8c4d"),
                            Description = "Comic Franchise",
                            Name = "Marvel"
                        },
                        new
                        {
                            FranchiseId = new Guid("ca30e999-a548-4475-be95-958a0ced8b22"),
                            Description = "Comic Franchise",
                            Name = "DC"
                        },
                        new
                        {
                            FranchiseId = new Guid("eac17e4f-2f16-473a-a0a7-be8d78aa9b0a"),
